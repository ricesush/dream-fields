...
@section('content')
    <div class="Bsr-banner-sell container-fluid position-relative">
            ...
            <form class="bgColor2 py-3 rounded-1 shadow mb-5" method="GET" action="{{ route('search') }}">
                ...
                <div class="row col-md-12 col-lg-12 d-flex justify-content-center align-items-end m-0">
                    ...
                    <div class="col-lg-8 d-flex text-light align-items-end">
                        <input type="text"
                            class="bg-primary input text-dark form-control bg-transparent border-0 border-bottom rounded-0 border-b"
