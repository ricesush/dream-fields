...
@section('content')
    ...
    <div class="text-center">
        <h1 class='text-3xl font-bold text-gray-800 mb-2'>Would you like to list a property <br />in our website?
        </h1>
        ...
        <div class="w-1/3">
            <form method="POST" action="{{ route('createproperty') }}" class="bg-white p-4 rounded-lg shadow-md">
                ...
                <div class="text-center mt-4">
                    <button type="submit"
                        class="bg-blue-500 text-white py-2 px-4 rounded-full hover:bg-blue-600">Submit</button>
                </div>
            </form>
        </div>
    </div>
