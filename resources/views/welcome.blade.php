                ...
                <section class='col-lg-12 row d-flex align-items-center justify-content-center'>
                    ...
                    <div class='row col-lg-6 d-flex mt-3 homeBtn'>
                        <a href="{{ route('buypage') }}"
                            class='col-lg-3 border border-1 rounded-1 fw-bold welcomeBtn d-flex align-items-center justify-content-center'>
                            <span></span>
    ...
    <div class="container-fluid bg-light mt-5">
        <div class="container">
            <div id="carouselExampleIndicators" class="carousel slide secHeight">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="https://cdn.slidesharecdn.com/ss_thumbnails/fieldsaleskit-140621040636-phpapp02-thumbnail-4.jpg?cb=1403481306"
                            class="d-block w-100" alt="...">
                    </div>
                    <div class="carousel-item">
                        <img src="https://pinoydeal.ph/oc-content/uploads/937/176007_original.jpg"
                            class="d-block w-100 h-50" alt="...">
                    </div>
                    <div class="carousel-item">
                        <img src="https://www.filbuild.com/philippines/real_estate/condominium/paranaque_city/smdc/field_residences/assets/Field_Residences_1BR_Living_Dining_Kitchen.jpg"
                            class="d-block w-100 h-50" alt="...">
                    </div>
                </div>
            ...
            <div class="container d-flex justify-content-center">
                <div class="p-5">
                    <iframe
                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d965.7699582794213!2d120.99299741264272!3d14.480105128830566!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3397ce8755efe74b%3A0x716eb952ca28c1ae!2sField%20Residences%20-%20Building%201!5e0!3m2!1sen!2sph!4v1675903810012!5m2!1sen!2sph"
