        ...
        <form class="bgColor2 py-3 rounded-1">
            ...
            <div class="row col-md-12 col-lg-12 d-flex justify-content-center m-0">
                <div class=" col-lg-4 col-md-12 d-flex me-0">
                    <select class="form-select bg-transparent border-0 border-bottom rounded-0 text-center" name="links" id="unitProperties">
                        <option selected hidden value="Listing" class="text-dark">Listing</option>
                        <option value="for_sale">For Sale</option>
                        <option value="for_rent">For Rent</option>
                    </select>
                    <select class="form-select bg-transparent border-0 border-bottom rounded-0 mx-3 text-center" name="baths" id="baths">
                    ...
                    <select class="form-select bg-transparent border-0 border-bottom rounded-0 text-center pt-2" name="baths" id="beds">
